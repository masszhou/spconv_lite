...
#ifndef SPCONV_CPP_MAXPOOL_CUH
#define SPCONV_CPP_MAXPOOL_CUH
#include <torch/script.h>

namespace spconv {

void maxpool_bwd_cuda(torch::Tensor outFeatures,
...
void maxpool_fwd_cuda(torch::Tensor outFeatures,
                      torch::Tensor inFeatures,
                      torch::Tensor indicesIn,
                      torch::Tensor indicesOut,
                      int size);
